...
public interface IDispatchObject
{
    ...
    //     /// <br/><br/>    /// The target queue of inactive objects can be changed using
    ...
    //     /// <br/><br/>    /// Calling <see cref="Activate"/> on an active object has no effect.
    //     /// </remarks>
    ...
    //     /// <br/><br/>    /// If the specified object has zero suspension count and is not an inactive
    ...
    //     public abstract void SetTargetQueue([CanBeNull] DispatchQueue queue);
    //     
    //     /// <summary>
    ...
    //     /// <br/><br/>    /// Calls to <see cref="Suspend"/> must be balanced with calls
    //     /// to <see cref="Resume"/>.
    //     /// </remarks>
